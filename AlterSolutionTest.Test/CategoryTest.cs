...
namespace AlterSolutionTest.Test
{
    public class CategoryTest
    {
        ...
        public async Task MustGetCategoryById()
        {
            ...
            await _categoryController.Insertategory(category);

            var actual = (_categoryController.GetCategory(category.Id).Result as OkObjectResult).StatusCode;
        ...
        public async Task MustCreateCategory()
        {
            ...
            var actual = (_categoryController.Insertategory(category).Result as OkObjectResult).StatusCode;
            var expected = new OkResult().StatusCode;
        ...
        public async Task MustUpdateCategory()
        {
            ...
            var act = (_categoryController.UpdateCategory(category).Result as OkObjectResult).StatusCode;
        ...
        public async Task MustDeleteCategory()
        {
            ...
            var act = _categoryController.DeleteCategory(category.Id).Result as OkObjectResult;
            var exp = new OkResult().StatusCode;
